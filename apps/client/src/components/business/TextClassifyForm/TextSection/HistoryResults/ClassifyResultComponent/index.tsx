  ...
  if (isClassifyErrorResult(result)) {
    return (
      <div className="relative">
        ...
        <button
          className="absolute right-4 top-1/2 flex h-6 w-6 -translate-y-1/2 items-center justify-center rounded-md"
    ...
    return (
      <div className="flex animate-fadein flex-col gap-2 rounded-md bg-slate-700 p-4">
        ...
        <div className="flex flex-row gap-2">
          <div className="flex w-0 grow flex-row overflow-auto pb-1">
          ...
          <button
            className="flex h-6 w-6 items-center justify-center rounded-md bg-slate-600"
            onClick={handleDelete}
            tabIndex={-1}
          >
            <DeleteIcon />
    ...
    return (
      <div className="flex animate-fadein flex-col gap-2 rounded-md bg-slate-700 p-4">
        <p className="break-words rounded-md border-2 border-zinc-400/25 p-2">{result.text}</p>
        <div className="flex flex-row gap-2">
          <div className="flex w-0 grow flex-row overflow-auto pb-1">
            <div className="flex w-0 grow flex-row gap-2">
              {result.tags
