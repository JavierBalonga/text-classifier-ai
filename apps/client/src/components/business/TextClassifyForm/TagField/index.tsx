...
export interface TagFieldProps {
  ...
  onTagNameBlur: (e: React.FocusEvent<HTMLInputElement>) => void;
  onTagDescriptionChange: (e: React.ChangeEvent<HTMLTextAreaElement>) => void;
  onTagDescriptionBlur: (e: React.FocusEvent<HTMLTextAreaElement>) => void;
